...
st.set_page_config(page_title= "BizCardX: Extracting Business Card Data with OCR | By Prema",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This OCR app is created by *Prema*!"""})
...
if selected == "Upload & Extract":
    ...
    if uploaded_card is not None:
        ...
        def save_card(uploaded_card):
            with open(os.path.join(r"C:\Users\prema\Downloads\capstone_projects\Bizcard\uploaded_cards\uploaded_card.name"), "wb") as f:
